...
class RewardsControllerTest < ActionController::TestCase
  ...
  test "should create reward" do
    assert_difference('Reward.count') do
      post :create, reward: { decimal: @reward.decimal, manufacture: @reward.manufacture, name: @reward.name }
    end
  ...
  test "should update reward" do
    patch :update, id: @reward, reward: { decimal: @reward.decimal, manufacture: @reward.manufacture, name: @reward.name }
    assert_redirected_to reward_path(assigns(:reward))
  end
